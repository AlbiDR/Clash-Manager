...
/**
 * Migration: Update Donation Weight in Performance Metrics
 * -----------------------------------------------------------------------
 * Increased the weight of donations in the scoring formula from 100 to 115
 * to better reward member contributions.
 */
