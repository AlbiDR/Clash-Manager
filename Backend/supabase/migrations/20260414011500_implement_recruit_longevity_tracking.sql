...
-- 1. Drop existing views to allow column expansion (Legacy Parity)
DROP VIEW IF EXISTS drivers.top_recruits_view;
DROP VIEW IF EXISTS features.headhunter_view;

-- 2. Create features.headhunter_view with longevity tracking
...
-- 3. Recreate drivers.top_recruits_view
