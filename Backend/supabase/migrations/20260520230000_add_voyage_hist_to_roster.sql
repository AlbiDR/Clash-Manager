...
/**
 * Migration: Add Voyage History (v_hist) to features.roster_view
 * -----------------------------------------------------------------------
 * Rebuilds features.scoring_view and features.roster_view to expose
 * a serialized string of voyage history for the frontend chart.
 */
