...
/**
 * Migration: Fix war participation rate denominator (regression fix)
 *
 * Rationale:
 * - Re-apply the fix to change war participation denominator from 4.0 back to 16.0
 *   (4 days * 4 decks/day = 16 max decks per week) to prevent values > 100%.
 * - Adjust the war_rate score multiplier from 150.0 to 600.0 to preserve absolute contribution.
 */
...
-- 1. Rebuild features.scoring_view with 16.0 denominator & 600.0 multiplier
