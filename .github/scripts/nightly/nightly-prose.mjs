...
export const FAILURE_PHRASES = {
  ...
  JULES_SESSION_EMPTY: "Its Jules session ran to completion but produced no change set at all, so there was nothing to publish or recover.", // 0, first seen 2026-09-06
