...
test("a whole recap is assembled and rendered from evidence alone", () => {
  ...
  assert.equal(text, [
    ...
    "| --- | --- | --- | --- | --- |",
    "| S01 | CLEAN | #2001 | hardening | nothing to do |",
    "| S02 | CLEAN | #2002 | verification | nothing to do |",
    "| S03 | CLEAN | #2003 | baseline-consolidation | nothing to do |",
    "| S04 | CLEAN | #2004 | optimization | nothing to do |",
    "| S05 | CLEAN | #2005 | documentation-readme | nothing to do |",
    "| S06 | CLEAN | #2006 | documentation-tsdoc | nothing to do |",
    "| S07 | CLEAN | #2007 | version-integrity | nothing to do |",
    "| S08 | CLEAN | #2008 | dependency-audit | nothing to do |",
    "| S09 | CLEAN | #2009 | refactor | nothing to do |",
    "| S10 | CLEAN | #2010 | apk-integrity | nothing to do |",
    "| S11 | CLEAN | #2011 | apk-optimization | nothing to do |",
    "| S12 | CLEAN | #2012 | apk-ux | nothing to do |",
    "| S13 | CLEAN | #2013 | self-healing-protocol | nothing to do |",
    "",
  ].join("\n"));
});
