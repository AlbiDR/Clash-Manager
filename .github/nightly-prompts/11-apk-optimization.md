...
- **Description Template:**
  ...
  ### Reasoning:
  **[Bottleneck Identified]:** <Describe the specific compilation inefficiency, asset bloat, or cache misconfiguration found.>
  **[Impact]:** <Explain the measurable effect on APK download size or WebView initialization latency.>
  **[Rationale]:** <Detail why this specific configuration change is safe and produces a measurable improvement.>

  ### Changes:
  - **[Component/File]:** <Description of the build rule, cache profile, or asset setting updated.>

  ### Verification:
  - **[Automated]:** Confirm successful compile and build output.
  - **[Automated/Audit]:** Confirm the optimization target is addressed in the updated configuration.
