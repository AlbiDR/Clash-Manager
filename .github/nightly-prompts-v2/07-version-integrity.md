...
identity: stage-7-version-integrity
core-task: monorepo-version-reconciliation
primary-tools: [list_dir, view_file, grep_search]
forbidden-actions: [apply_migration, execute_sql, increment-version, upgrade-deps]
---
...
- **Description Template:**
  ```markdown
  ### Generated by: .github/nightly-prompts-v2/07-version-integrity.md
