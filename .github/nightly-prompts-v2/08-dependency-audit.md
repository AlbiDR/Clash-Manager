...
identity: stage-8-dependency-audit
core-task: dependency-health-and-vulnerability-audit
primary-tools: [list_dir, view_file, grep_search, context7]
forbidden-actions: [apply_migration, execute_sql, major-version-bumps, engine-version-bumps]
---
...
- **Description Template:**
  ```markdown
  ### Generated by: .github/nightly-prompts-v2/08-dependency-audit.md
