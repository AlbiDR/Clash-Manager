...
// Consolidated paths object with NO duplicates
const paths: Record<string, string> = {
  ...
  'warlog': 'M19,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.1,3,19,3z M12,18 c-0.55,0-1-0.45-1-1v-5c0-0.55,0.45-1,1-1s1,0.45,1,1v5C13,17.55,12.55,18,12,18z M12,9c-0.55,0-1-0.45-1-1S11.45,7,12,7s1,0.45,1,1 S12.55,9,12,9z',
