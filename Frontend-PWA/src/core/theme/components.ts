...
/* The collapsing console header. is-scrolled is bound on .console-header
   ...
   its padding and radius around a title that stayed at full size. ConsoleHeader
   deliberately applies title size changes immediately, so its pressure
   resolver measures final glyph widths rather than an animation frame.
