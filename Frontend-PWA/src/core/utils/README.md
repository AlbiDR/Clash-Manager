...
- **math.ts**: Authoritative SSOT for **standardized numeric formatting** (`formatNumber`), supporting locale-aware separators and custom options. Handles basic numeric sanitization and trend momentum calculations.
