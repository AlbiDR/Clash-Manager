...
describe("warMath", () => {
  ...
  describe("calculatePrediction", () => {
    ...
    it("adds streak bonus if last 3 weeks are above threshold", () => {
      const threshold = WAR_CONSTANTS.WIN_THRESHOLD; // 2000
      const bonus = WAR_CONSTANTS.STREAK_BONUS; // 160
      // [2500, 2500, 2500] -> weight for 3: [0.6, 0.3, 0.1]
      // 0.6 * 2500 + 0.3 * 2500 + 0.1 * 2500 = 1500 + 750 + 250 = 2500
      // 2500 + 160 = 2660
      expect(calculatePrediction([2500, 2500, 2500])).toBe(2500 + bonus);
    });
