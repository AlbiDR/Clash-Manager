...
- **game.ts**: Authoritative Clash Royale domain logic and centralized XP calculation utilities. Decomposed into `gameConstants.ts` (static tables) and `gameTypes.ts` (domain interfaces).
