 ...
 * Manages PWA update checks, cache clearing, and application factory resets.
 */
export function useSystemRecovery() {
  ...
  /**
   * 🔄 FORCE UPDATE
   * Triggers a manual check for Service Worker updates and handles installation.
   */
  ...
  /**
   * 🧹 PURGE ASSETS
   * Unregisters service workers and clears all cache storage.
   */
  ...
  /**
   * ☢️ FACTORY RESET
   * Clears all local storage, session storage, and IndexedDB data.
   */
