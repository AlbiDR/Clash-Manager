...
const { handleTap, handleLongPress, handleScoreClick: internalScoreClick, handleExpandClick: internalExpandClick } = useCardMechanics(
    props,
    {
...
.card.selected :deep(.sc-val) { 
  color: var(--sys-color-on-primary-container) !important; opacity: 1 !important; 
}

.card.selected :deep(.stat-pod) { background: rgba(var(--sys-color-on-primary-container-rgb, 0,29,54), 0.12) !important; color: var(--sys-color-on-primary-container) !important; border: 1px solid rgba(var(--sys-color-on-primary-container-rgb), 0.1); }
.card.selected :deep(.badge:not(.role)) { background: rgba(var(--sys-color-on-primary-container-rgb, 0,29,54), 0.1) !important; color: var(--sys-color-on-primary-container) !important; border: none; }
...
:deep(.hit-target) { position: relative; z-index: 5; }
:deep(.hit-target)::after { content: ''; position: absolute; inset: -4px; }
</style>
