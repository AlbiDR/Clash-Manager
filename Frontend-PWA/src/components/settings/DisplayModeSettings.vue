...
<template>
  <SettingsCard title="Display Preferences" icon="visibility" :loading="loading">
    <div class="features-list">
      ...
      >
        <div class="row-info">
          ...
          <div class="row-desc">Populate the interface with high-fidelity mock data</div>
        </div>
      ...
      >
        <div class="row-info">
          ...
          <div class="row-desc">Strip UI to geometric skeletons to audit layout stability</div>
        </div>
      ...
      <div class="mode-master-container" :class="{ active: isShowcaseMode }">
        ...
        >
          <div class="row-info">
            ...
            <div class="row-desc">
              A curated fusion environment leveraging both synthetic data and structural
              skeletons
            </div>
          </div>
